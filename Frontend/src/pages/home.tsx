...
<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
  ...
  {/* 1. Bulkwave - Full Width, Centered Stack, Purple Background */}
  <div 
...
{/* 4. Finedge - Full Width, Centered Stack, Navy Background */}
<div 
...
{/* 5. Smerp Go - Left Side (Very Light Purple) */}
<div 
  className="rounded-[40px] md:rounded-[60px] pb-6 px-8 overflow-hidden relative flex flex-col items-center text-center"
  style={{ backgroundColor: '#f5f3ff' }}
>
  {/* Phone Image - Pushed up with negative margin to tighten space */}
...
{/* 6. UCP - Right Side (Very Light Blue) */}
<div 
...
>
  ...
  {/* Phone Image - Pushed down to bleed off the card and tighten text area */}
...
{/* 7. beetVAS - Full Width, Centered Stack, Purple/Blue Mixture Background */}
<div 
